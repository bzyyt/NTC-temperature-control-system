...
** LCD1602接口定义
*********************************************************************************************************/
sbit RS_1602 = P3 ^ 5; // 数据命令选择端
sbit RW_1602 = P3 ^ 6; // 写选择端
sbit EN_1602 = P3 ^ 7; // 使能信号
...
unsigned char code self_definition_char[] = {
    ...
    0x10, 0x06, 0x09, 0x08, 0x08, 0x09, 0x06, 0x00, //"度"代码
...
unsigned char code table1[] = {0x10, 0x06, 0x09, 0x08, 0x08, 0x09, 0x06, 0x00}; // 字符℃
/*******************************************CGRAM起始地址**************************************************/
